...
export default function SobreMi() {
  return (
    <div className="bg-white">
      ...
      <section className="section-container bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-lg mx-auto">
            ...
            <p className="text-lg text-royal-blue-700 leading-relaxed mb-6">
            ...
            <p className="text-lg text-royal-blue-700 leading-relaxed">
      ...
      {/* CTA */}
      <section className="section-container bg-white">
        <div className="max-w-4xl mx-auto text-center bg-purple-50 rounded-3xl p-12">
