...
export default function Fiestas() {
  const service = services.find(s => s.id === 'fiestas')!

  return (
    <div>
      <Hero
        title="Fotografía de Fiestas y Celebraciónes"
        subtitle="Momentos llenos de vida y alegría, capturados para siempre."
      />

      <section className="section-container bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-lg mx-auto text-center mb-12">
            <h2 className="heading-2 mb-6">Celebraciónes Espontáneas y Naturales</h2>
            <p className="text-xl text-gray-700 leading-relaxed mb-6">
              {service.description}
            </p>
            <p className="text-lg text-primary-600 leading-relaxed">
              Ya sea un cumpleaños, graduación, aniversario o cualquier celebración especial, 
              capturo la energía y los momentos espontáneos que hacen única cada fiesta.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section-container bg-primary-50">
        <div className="text-center mb-12">
          <h2 className="heading-2 mb-4">Galería de Fiestas</h2>
        </div>
      ...
      <section className="section-container bg-white">
        <div className="text-center mb-12">
          <h2 className="heading-2 mb-4">Proceso Simple y Efectivo</h2>
        </div>
      ...
      <section className="section-container bg-gradient-to-r from-primary-700 to-primary-700 text-white">
        <div className="text-center mb-12">
          <h2 className="heading-2 mb-4 text-white">Paquetes para Fiestas</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="section-container bg-gradient-to-br from-primary-900 via-primary-800 to-primary-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a
            href="https://wa.me/50660140366?text=Hola, me gustaría reservar una fecha para una fiesta"
            target="_blank"
