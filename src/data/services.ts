...
export const services: Service[] = [
  {
    ...
    image: '/images/Bodas/ANT_5208-Enhanced-NR-2.webp',
    gallery: [
      { id: 'boda-1', src: '/images/Bodas/ANT_1422-Enhanced-NR.webp', alt: 'Foto de boda 1' },
      { id: 'boda-2', src: '/images/Bodas/ANT_5208-Enhanced-NR-2.webp', alt: 'Foto de boda 2' },
      { id: 'boda-3', src: '/images/Bodas/ANT_5349-Enhanced-NR.webp', alt: 'Foto de boda 3' },
      { id: 'boda-4', src: '/images/Bodas/ANT_5411-Enhanced-NR.webp', alt: 'Foto de boda 4' },
      { id: 'boda-5', src: '/images/Bodas/ANT_8486-Enhanced-NR-2.webp', alt: 'Foto de boda 5' },
      { id: 'boda-6', src: '/images/Bodas/ANT_9085-Enhanced-NR.webp', alt: 'Foto de boda 6' },
      { id: 'boda-7', src: '/images/Bodas/MFS_4559.webp', alt: 'Foto de boda 7' },
      { id: 'boda-8', src: '/images/Bodas/MFS_4561.webp', alt: 'Foto de boda 8' },
      { id: 'boda-9', src: '/images/Bodas/MFS_6333-Enhanced-NR.webp', alt: 'Foto de boda 9' },
      { id: 'boda-10', src: '/images/Bodas/MFS_6385-Enhanced-NR.webp', alt: 'Foto de boda 10' },
      { id: 'boda-11', src: '/images/Bodas/MFS_6466-Enhanced-NR.webp', alt: 'Foto de boda 11' },
      { id: 'boda-12', src: '/images/Bodas/MFS_6512-Enhanced-NR.webp', alt: 'Foto de boda 12' },
      { id: 'boda-13', src: '/images/Bodas/_D3X1373-Enhanced-NR.webp', alt: 'Foto de boda 13' },
      { id: 'boda-14', src: '/images/Bodas/_D3X1411-Enhanced-NR-2.webp', alt: 'Foto de boda 14' },
      { id: 'boda-15', src: '/images/Bodas/_LP32487-Enhanced-NR.webp', alt: 'Foto de boda 15' },
      { id: 'boda-16', src: '/images/Bodas/_LP33034-Enhanced-NR.webp', alt: 'Foto de boda 16' },
      { id: 'boda-17', src: '/images/Bodas/_LP33065-Enhanced-NR.webp', alt: 'Foto de boda 17' },
      { id: 'boda-18', src: '/images/Bodas/_LP33200-Enhanced-NR.webp', alt: 'Foto de boda 18' },
      { id: 'boda-19', src: '/images/Bodas/_LP35490-Enhanced-NR-2.webp', alt: 'Foto de boda 19' },
      { id: 'boda-20', src: '/images/Bodas/_LP35634-Enhanced-NR.webp', alt: 'Foto de boda 20' },
    ],
    packages: [
      {
        name: 'Esencial',
  ...
  },
  {
    ...
    image: '/images/Chicos/MFS_5193-Enhanced-NR.webp',
    gallery: [
      { id: 'fiesta-1', src: '/images/Chicos/MFS_0872-Enhanced-NR.webp', alt: 'Foto de fiesta 1' },
      { id: 'fiesta-2', src: '/images/Chicos/MFS_5193-Enhanced-NR.webp', alt: 'Foto de fiesta 2' },
      { id: 'fiesta-3', src: '/images/Chicos/MFS_5247-Enhanced-NR-2.webp', alt: 'Foto de fiesta 3' },
      { id: 'fiesta-4', src: '/images/Chicos/MFS_5997-Enhanced-NR-2.webp', alt: 'Foto de fiesta 4' },
      { id: 'fiesta-5', src: '/images/Chicos/MFS_6530-Enhanced-NR-2-2.webp', alt: 'Foto de fiesta 5' },
      { id: 'fiesta-6', src: '/images/Chicos/MFS_7241-Enhanced-NR.webp', alt: 'Foto de fiesta 6' },
      { id: 'fiesta-7', src: '/images/Chicos/MFS_7519-Enhanced-NR-2.webp', alt: 'Foto de fiesta 7' },
  ...
  },
  {
    ...
    image: '/images/Empresarial /DSC_6773-Enhanced-NR-2.webp',
    gallery: [
      { id: 'corp-1', src: '/images/Empresarial /DSC_3956.webp', alt: 'Foto corporativa 1' },
      { id: 'corp-2', src: '/images/Empresarial /DSC_4122.webp', alt: 'Foto corporativa 2' },
      { id: 'corp-3', src: '/images/Empresarial /DSC_4269.webp', alt: 'Foto corporativa 3' },
      { id: 'corp-4', src: '/images/Empresarial /DSC_6751-Enhanced-NR.webp', alt: 'Foto corporativa 4' },
      { id: 'corp-5', src: '/images/Empresarial /DSC_6758-Enhanced-NR.webp', alt: 'Foto corporativa 5' },
      { id: 'corp-6', src: '/images/Empresarial /DSC_6773-Enhanced-NR-2.webp', alt: 'Foto corporativa 6' },
      { id: 'corp-7', src: '/images/Empresarial /DSC_6931-Enhanced-NR.webp', alt: 'Foto corporativa 7' },
      { id: 'corp-8', src: '/images/Empresarial /DSC_6956-Enhanced-NR.webp', alt: 'Foto corporativa 8' },
      { id: 'corp-9', src: '/images/Empresarial /DSC_7006-Enhanced-NR.webp', alt: 'Foto corporativa 9' },
  ...
  },
  {
    ...
    image: '/images/Editorial/DSC_5327-Enhanced-NR.webp',
    gallery: [
